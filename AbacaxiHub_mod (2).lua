...
-- [[ Speed settings ]] --
getgenv().TweenSpeedFar = 60
getgenv().TweenSpeedNear = 100
...
-- ===============================  
local speed = dist <= 15 and (getgenv().TweenSpeedNear or 100) or (getgenv().TweenSpeedFar or 60)
...
-- Load library (Bananui - YuiSess)
Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/YuiSess/Bananui/refs/heads/main/Sla"))()
...
Section2:AddLabel("Script Made By Abacaxi")
...
-- ========================================
getgenv().TweenSpeedFar = 30
getgenv().TweenSpeedNear = 50
...
-- Select speed
    speed = dist <= 15 and (getgenv().TweenSpeedNear or 50) or (getgenv().TweenSpeedFar or 30)
...
local npcPos = CFrame.new(-9516.99, 172.01, 6078.46) -- NPC position for Bones
...
-- Try to get quest based on level (optional: randomized like in original)
                ...
                -- [STEP 2] If quest already accepted or not needed, go farm
                else
...
-- =========================================================
LogoID = "rbxassetid://120488231660846"
